...
Shader "Toon/TEM_CustomStoneCylindrical"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline float4 TriplanarSampling215( sampler2D topTexMap, sampler2D midTexMap, sampler2D botTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
		{
		...
		inline float3 TriplanarSampling217( sampler2D topTexMap, sampler2D midTexMap, sampler2D botTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
		{
			float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
			projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
			float3 nsign = sign( worldNormal );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 triplanar215 = TriplanarSampling215( _OverlayTexture, _MainTexture, _MainTexture, ase_positionWS, ase_normalWS, 8.0, temp_cast_2, float3( 1,1,1 ), float3(0,0,0) );
			...
			float3 triplanar217 = TriplanarSampling217( _OverlayNormalMap, _MainNormalMap, _MainNormalMap, ase_positionWS, ase_normalWS, 8.0, temp_cast_3, temp_cast_4, float3(0,0,0) );
			...
			float2 temp_cast_5 = (temp_output_149_0).xx;
			...
			#ifdef UNITY_PASS_FORWARDBASE
				float3 staticSwitch157 = temp_cast_7;
			#else
				float3 staticSwitch157 = temp_output_144_0;
			#endif
			float4 CustomLighting109 = ( ( float4( ( indirectDiffuse142 * ase_lightColor.rgb * ase_lightColor.a ) , 0.0 ) * BlendedTextures167 ) + ( ( ( tex2D( _TextureRamp, temp_cast_5 ) * float4( ( ase_lightColor.rgb + indirectDiffuse142 ) , 0.0 ) ) * ( temp_output_149_0 * max( max( break147.x , break147.y ) , break147.z ) ) ) * ( BlendedTextures167 * float4( staticSwitch157 , 0.0 ) ) ) );
...
Node;AmplifyShaderEditor.TriplanarNode;217;2208,-3312;Inherit;True;Cylindrical;World;True;Top Texture 1;_TopTexture1;white;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;8;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;219;2432,-4208;Inherit;False;218;OverlayTextureTiling;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TriplanarNode;215;2752,-4304;Inherit;True;Cylindrical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;8;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2048,-6784;Float;False;True;-1;2;;0;0;CustomLighting;Toon/TEM_CustomStoneCylindrical;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=F27FC13B676EBF9F5FBD18EBC00838F45EF26258